...
The code will automatically start a new day at midnight in your current timezone, storing your nutritional data from that day
As this is not actually an app there are commands to end/start a new day early and exit the program.
AI was only used to troubleshoot errors, all code was written by me.
